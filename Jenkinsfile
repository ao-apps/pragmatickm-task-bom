...
def upstreamProjects = [
  ...
  // BOM
  'all', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-task-all</artifactId>
  ...
  'style', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-task-style</artifactId>
  'taglib', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-task-taglib</artifactId>
  'view', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-task-view</artifactId>
]
